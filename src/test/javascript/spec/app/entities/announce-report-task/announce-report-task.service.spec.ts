...
describe('Service Tests', () => {
    ...
    describe('AnnounceReportTask Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(AnnounceReportTaskService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/announce-report-tasks';
                expect(req.request.url).toEqual(resourceUrl + '/' + '123');
            });
            it('should return AnnounceReportTask', () => {
